...
basewidth = 2048 # output size of generated image 
deterministic_mode = True  # reproducible results [True, False]
generate_gif = False # generate animation [True, False]
deterministic_seed = 42 # seed for pseudo-random generator
N = 5000 # number of objects in created image
# genetic optimization
NEvo = 20 # number of evolution steps per one optimized object 
MAX_BUFF = 10  # stopping evolution if there are no changes (MAX_BUFF consecutive evolution steps)
MAX_ADDMUT = 7 # [%] - maximum aditive mutation range
LINE_WIDTH = 16 # [px] line width
MLTPL_EVO_PARAMS = 6 # parameter multiplier
